...
class MyApp extends StatelessWidget {   // 상태 변화가 없는 애
...
// 시작클래스가 표시되는 클래스. 카운터 앱 화면
class MyHomePage extends StatefulWidget {   // 상태가 변하는 애, 정보가 변함
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;   // 화면에 표시한 상태값이 카운터 숫자
